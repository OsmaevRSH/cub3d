...
void	ft_init_textures(t_mlx *mlx)
{
	...
	mlx->texture.sprite_1.mlx_img = mlx_xpm_file_to_image(mlx->mlx, mlx->map.S, &mlx->texture.sprite_1.weight, &mlx->texture.sprite_1.height);
	mlx->texture.sprite_2.mlx_img = mlx_xpm_file_to_image(mlx->mlx, mlx->map.SS, &mlx->texture.sprite_2.weight, &mlx->texture.sprite_2.height);
	...
	mlx->texture.sprite_1.mlx_addr = (int *)mlx_get_data_addr(mlx->texture.sprite_1.mlx_img, &mlx->texture.sprite_1.mlx_bits_per_pixel, &mlx->texture.sprite_1.mlx_line_length, &mlx->texture.sprite_1.mlx_endian);
	mlx->texture.sprite_2.mlx_addr = (int *)mlx_get_data_addr(mlx->texture.sprite_2.mlx_img, &mlx->texture.sprite_2.mlx_bits_per_pixel, &mlx->texture.sprite_2.mlx_line_length, &mlx->texture.sprite_2.mlx_endian);
}
